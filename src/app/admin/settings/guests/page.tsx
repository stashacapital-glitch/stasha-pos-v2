            ...
            {guests.length === 0 ? (
                ...
                guests.map((guest) => (
                  <tr key={guest.id} className="hover:bg-gray-700/50">
                    ...
                    <td className="p-4">
                      {guest.current_room ? (
                        <span className="px-2 py-1 bg-purple-900 text-purple-300 rounded text-xs font-bold">Room {guest.current_room}</span>
                      ) : (
                        <span className="text-gray-500 text-xs">Not Checked In</span>
                      )}
                    </td>
                    <td className="p-4 font-mono text-orange-400 text-sm">KES {guest.current_bill?.toLocaleString() || 0}</td>
